...
const RegisterScreen = ({ navigation }: RegisterScreenProps): JSX.Element => {
    ...
    return (
        <BaseLayout>
            <Text style={styles.title} variant="bodyMedium">Register</Text>
            <View style={styles.input}>
                ...
                />
                { errors.profile?.fullname && <Text style={styles.error}>{errors.profile.fullname.message}</Text> }
            </View>
            ...
            <View style={styles.input}>
                ...
                />
                { errors.profile?.nickname && <Text style={styles.error}>{errors.profile.nickname.message}</Text> }
            </View>
            ...
            <View style={styles.input}>
                ...
                />
                { errors.user?.email && <Text style={styles.error}>{errors.user.email.message}</Text> }
            </View>
            ...
            <View style={styles.input}>
                ...
                />
                { errors.user?.password && <Text style={styles.error}>{errors.user.password.message}</Text> }
            </View>
          <Button style={styles.button} mode="contained" onPress={handleSubmit(submitRegisterForm)}>Register</Button>
        </BaseLayout>
    )
}
